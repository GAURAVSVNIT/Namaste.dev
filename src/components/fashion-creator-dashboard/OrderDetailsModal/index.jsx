...
import { X, Package, User, MapPin, CreditCard, Calendar, Truck, Phone, Mail, Palette } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Commission Order Details</h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className={`px-3 py-1 text-sm rounded-full font-medium ${
                ...
                {order.source === 'razorpay' ? 'Razorpay' : 'Direct Commission'}
              </span>
              <Button
                variant="ghost"
                size="sm"
                  ...
                  {order.items.map((item, index) => (
                    <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded">
                      <div>
                        ...
                        {item.sku && <p className="text-sm text-gray-500">Service ID: {item.sku}</p>}
