            ...
            <div className={styles.activityList}>
              {dashboardData.recentOrders && dashboardData.recentOrders.length > 0 ? (
                dashboardData.recentOrders.slice(0, 4).map((order, index) => {
                  const timeAgo = order.createdAt ? new Date(order.createdAt.seconds * 1000).toLocaleString() : 'Recently';
                  return (
                    <motion.div
                      key={order.id}
                      ...
                      className="flex items-start p-4 hover:bg-gray-50/80 transition-colors group"
                    >
                ...
                [
                  ...
                  { 
                    icon: Package, 
                    text: 'Product "Summer Collection" updated', 
                    time: '1 hour ago', 
                    color: 'purple',
                    status: 'Update'
                  },
