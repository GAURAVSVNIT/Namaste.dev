...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="forgot-password-container" role="main" aria-labelledby="forgot-password-title">
      <style jsx global>{`
      ...
      <div className="w-full max-w-md">
        <div className="glass-card p-8 rounded-2xl shadow-2xl">
          ...
          <div className="text-center mb-8">
            <h1 id="forgot-password-title" className="text-3xl font-bold gradient-text mb-2">
